...
public class PermissionHelper {
    ...
    private final static int READ_CONTACTS_CODE = 103;
    private final static int RECORD_AUDIO_CODE = 104;
   // private final static int WRITE_SETTINGS = 105;
    ...
    private PermissionModel[] mPermissionModels = new PermissionModel[]{
            ...
            new PermissionModel("联系人", Manifest.permission.READ_CONTACTS, "我们需要读取联系人的权限，这样才能提供快捷的问答",
                    READ_CONTACTS_CODE),
            new PermissionModel("麦克风", Manifest.permission.READ_CONTACTS, "我们需要读取麦克风的权限，这样才语音识别",
                    RECORD_AUDIO_CODE),
            /*new PermissionModel("配置文件", Manifest.permission.WRITE_SETTINGS, "我们需要写入配置文件的权限，这样才能保存信息",
                    WRITE_SETTINGS)*/
    };
